...
#
# Script generated by Vivado on Wed May 07 11:42:15 +0100 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : matrix_mult_zybo.sh
...
#
# Usage        : matrix_mult_zybo.sh
#                matrix_mult_zybo.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                matrix_mult_zybo.sh [-reset_run]
#                matrix_mult_zybo.sh [-reset_log]
#                matrix_mult_zybo.sh [-help]
#
...
# script info
echo -e "matrix_mult_zybo.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./matrix_mult_zybo.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_19 -L processing_system7_vip_v1_0_21 -L xlconstant_v1_1_9 -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_16 -L smartconnect_v1_0 -L axi_register_slice_v2_1_33 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot matrix_mult_zybo xil_defaultlib.matrix_mult_zybo xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim matrix_mult_zybo -key {Behavioral:sim_1:Functional:matrix_mult_zybo} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_768e.protoinst" -protoinst "protoinst_files/matrix_mult_zybo.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb matrix_mult_zybo.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./matrix_mult_zybo.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: matrix_mult_zybo.sh [-help]\n\
Usage: matrix_mult_zybo.sh [-step]\n\
Usage: matrix_mult_zybo.sh [-lib_map_path]\n\
Usage: matrix_mult_zybo.sh [-reset_run]\n\
Usage: matrix_mult_zybo.sh [-reset_log]\n\
Usage: matrix_mult_zybo.sh [-keep_index]\n\
Usage: matrix_mult_zybo.sh [-noclean_files]\n\n\
