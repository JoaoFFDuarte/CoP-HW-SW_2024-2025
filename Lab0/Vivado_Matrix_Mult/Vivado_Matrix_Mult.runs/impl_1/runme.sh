...
HD_PWD='C:/GitHub/CoP-HW-SW_2024-2025/Lab0/Vivado_Matrix_Mult/Vivado_Matrix_Mult.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log matrix_mult_zybo_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source matrix_mult_zybo_wrapper.tcl -notrace
