...
HD_PWD='C:/GitHub/CoP-HW-SW_2024-2025/Lab0/Vivado_Matrix_Mult/Vivado_Matrix_Mult.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log matrix_mult_zybo_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source matrix_mult_zybo_wrapper.tcl
