...
#define XPAR_AXIL_MACC_0_BASEADDR 0x40000000
#define XPAR_AXIL_MACC_0_HIGHADDR 0x4000ffff

/* Canonical definitions for peripheral AXIL_MACC_0 */
#define XPAR_XAXIL_MACC_0_BASEADDR 0x40000000
#define XPAR_XAXIL_MACC_0_HIGHADDR 0x4000ffff
