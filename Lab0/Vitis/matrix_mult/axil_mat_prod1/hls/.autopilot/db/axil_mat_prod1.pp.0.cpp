...
__attribute__((sdx_kernel("axil_mat_prod1", 0))) void axil_mat_prod1(int m1[1024], int m2[1024], int m3[1024], int N1, int N2, int N3)
{
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=axil_mat_prod1
# 4 "C:/GitHub/CoP-HW-SW_2024-2025/Lab0/axilite_matprod_files/HLS/axil_mat_prod1.cpp"
...
#pragma HLS INTERFACE s_axilite port=N3 bundle=BUS1
 ...
 VITIS_LOOP_16_1: for (i=0, j=0, k=0; i<N1; ) {
