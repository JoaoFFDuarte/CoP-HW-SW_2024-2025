...
entity axil_mat_prod1_BUS1_s_axi is
generic (
...
end entity axil_mat_prod1_BUS1_s_axi;
...
architecture behave of axil_mat_prod1_BUS1_s_axi is
    ...
    constant ADDR_N1_DATA_0 : INTEGER := 16#0010#;
    constant ADDR_N1_CTRL   : INTEGER := 16#0014#;
    constant ADDR_N2_DATA_0 : INTEGER := 16#0018#;
    constant ADDR_N2_CTRL   : INTEGER := 16#001c#;
    constant ADDR_N3_DATA_0 : INTEGER := 16#0020#;
    constant ADDR_N3_CTRL   : INTEGER := 16#0024#;
    constant ADDR_M1_BASE   : INTEGER := 16#1000#;
    constant ADDR_M1_HIGH   : INTEGER := 16#1fff#;
    constant ADDR_M2_BASE   : INTEGER := 16#2000#;
    constant ADDR_M2_HIGH   : INTEGER := 16#2fff#;
    constant ADDR_M3_BASE   : INTEGER := 16#3000#;
    constant ADDR_M3_HIGH   : INTEGER := 16#3fff#;
    ...
    -- memory signals
    signal int_m1_address0     : UNSIGNED(9 downto 0);
    signal int_m1_ce0          : STD_LOGIC;
    signal int_m1_q0           : UNSIGNED(31 downto 0);
    signal int_m1_address1     : UNSIGNED(9 downto 0);
    signal int_m1_ce1          : STD_LOGIC;
    signal int_m1_we1          : STD_LOGIC;
    signal int_m1_be1          : UNSIGNED(3 downto 0);
    signal int_m1_d1           : UNSIGNED(31 downto 0);
    signal int_m1_q1           : UNSIGNED(31 downto 0);
    signal int_m1_read         : STD_LOGIC;
    signal int_m1_write        : STD_LOGIC;
    signal int_m2_address0     : UNSIGNED(9 downto 0);
    signal int_m2_ce0          : STD_LOGIC;
    signal int_m2_q0           : UNSIGNED(31 downto 0);
    signal int_m2_address1     : UNSIGNED(9 downto 0);
    signal int_m2_ce1          : STD_LOGIC;
    signal int_m2_we1          : STD_LOGIC;
    signal int_m2_be1          : UNSIGNED(3 downto 0);
    signal int_m2_d1           : UNSIGNED(31 downto 0);
    signal int_m2_q1           : UNSIGNED(31 downto 0);
    signal int_m2_read         : STD_LOGIC;
    signal int_m2_write        : STD_LOGIC;
    signal int_m3_address0     : UNSIGNED(9 downto 0);
    signal int_m3_ce0          : STD_LOGIC;
    signal int_m3_be0          : UNSIGNED(3 downto 0);
    signal int_m3_d0           : UNSIGNED(31 downto 0);
    signal int_m3_address1     : UNSIGNED(9 downto 0);
    signal int_m3_ce1          : STD_LOGIC;
    signal int_m3_q1           : UNSIGNED(31 downto 0);
    signal int_m3_read         : STD_LOGIC;
    signal int_m3_write        : STD_LOGIC;

    component axil_mat_prod1_BUS1_s_axi_ram is
        generic (
    ...
    end component axil_mat_prod1_BUS1_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_m1
int_m1 : axil_mat_prod1_BUS1_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_m1_q1);
-- int_m2
int_m2 : axil_mat_prod1_BUS1_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_m2_q1);
-- int_m3
int_m3 : axil_mat_prod1_BUS1_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "S2P",
     BYTES     => 4,
...
-- ----------------------- AXI READ ----------------------
    ...
    RRESP   <= "00";  -- OKAY
    RVALID_t  <= '1' when (rstate = rddata) and (int_m1_read = '0') and (int_m2_read = '0') and (int_m3_read = '0') else '0';
    RVALID    <= RVALID_t;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    rdata_data <= int_m1_q1;
                elsif (int_m2_read = '1') then
                    rdata_data <= int_m2_q1;
                elsif (int_m3_read = '1') then
                    rdata_data <= int_m3_q1;
                end if;
            end if;
        end if;
    end process;
...
-- ----------------------- Memory logic ------------------
    ...
    int_m1_ce0           <= m1_ce0;
    m1_q0                <= STD_LOGIC_VECTOR(RESIZE(int_m1_q0, 32));
    int_m1_address1      <= raddr(11 downto 2) when ar_hs = '1' else waddr(11 downto 2);
    int_m1_ce1           <= '1' when ar_hs = '1' or (int_m1_write = '1' and WVALID  = '1') else '0';
    int_m1_we1           <= '1' when int_m1_write = '1' and w_hs = '1' else '0';
    int_m1_be1           <= UNSIGNED(WSTRB) when int_m1_we1 = '1' else (others=>'0');
    int_m1_d1            <= UNSIGNED(WDATA);
    -- m2
    int_m2_address0      <= UNSIGNED(m2_address0);
    int_m2_ce0           <= m2_ce0;
    m2_q0                <= STD_LOGIC_VECTOR(RESIZE(int_m2_q0, 32));
    int_m2_address1      <= raddr(11 downto 2) when ar_hs = '1' else waddr(11 downto 2);
    int_m2_ce1           <= '1' when ar_hs = '1' or (int_m2_write = '1' and WVALID  = '1') else '0';
    int_m2_we1           <= '1' when int_m2_write = '1' and w_hs = '1' else '0';
    int_m2_be1           <= UNSIGNED(WSTRB) when int_m2_we1 = '1' else (others=>'0');
    int_m2_d1            <= UNSIGNED(WDATA);
    -- m3
    int_m3_address0      <= UNSIGNED(m3_address0);
    int_m3_ce0           <= m3_ce0;
    int_m3_be0           <= (others => m3_we0);
    int_m3_d0            <= RESIZE(UNSIGNED(m3_d0), 32);
    int_m3_address1      <= raddr(11 downto 2) when ar_hs = '1' else waddr(11 downto 2);
    int_m3_ce1           <= ar_hs;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                ...
                if (ar_hs = '1' and raddr >= ADDR_M3_BASE and raddr <= ADDR_M3_HIGH) then
                    int_m3_read <= '1';
                else
                    int_m3_read <= '0';
                end if;
...
entity axil_mat_prod1_BUS1_s_axi_ram is
    generic (
        MEM_STYLE : STRING :="auto";
        MEM_TYPE  : STRING :="S2P";
        BYTES   : INTEGER :=4;
...
end entity axil_mat_prod1_BUS1_s_axi_ram;

architecture behave of axil_mat_prod1_BUS1_s_axi_ram is
