...
// 
// ==============================================================
# 1 "C:/GitHub/CoP-HW-SW_2024-2025/Lab0/axilite_matprod_files/HLS/tb_axil_mat_prod1.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 420 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/GitHub/CoP-HW-SW_2024-2025/Lab0/axilite_matprod_files/HLS/tb_axil_mat_prod1.cpp" 2
...
# 2 "C:/GitHub/CoP-HW-SW_2024-2025/Lab0/axilite_matprod_files/HLS/tb_axil_mat_prod1.cpp" 2
...
using std::wcstombs;
using std::wctomb;
# 3 "C:/GitHub/CoP-HW-SW_2024-2025/Lab0/axilite_matprod_files/HLS/tb_axil_mat_prod1.cpp" 2

# 1 "C:/GitHub/CoP-HW-SW_2024-2025/Lab0/axilite_matprod_files/HLS/axil_mat_prod1.h" 1
# 5 "C:/GitHub/CoP-HW-SW_2024-2025/Lab0/axilite_matprod_files/HLS/tb_axil_mat_prod1.cpp" 2
...
extern "C"
#endif
void apatb_axil_mat_prod1_sw(int *, int *, int *, int, int, int);
#endif
# 17 "C:/GitHub/CoP-HW-SW_2024-2025/Lab0/axilite_matprod_files/HLS/tb_axil_mat_prod1.cpp"
void axil_mat_prod1(int m1[1024], int m2[1024], int m3[1024], int rowsA, int rowsB, int rowsC);
...
void read_vecs_from_file()
{
  ...
  if ((fmats = fopen("C:/GitHub/CoP-HW-SW_2024-2025/Lab0/Vitis/m4.bin", "rb")) == 0LL) {
    fprintf((__acrt_iob_func(2)), "unable to open file <%s>\n", "C:/GitHub/CoP-HW-SW_2024-2025/Lab0/Vitis/m4.bin");
    exit(1);
  }

  fread(matA, 4*4, 4, fmats);
  fread(matB, 4*4, 4, fmats);
}
...
#ifndef HLS_FASTSIM
#define axil_mat_prod1 apatb_axil_mat_prod1_sw
#endif
# 77 "C:/GitHub/CoP-HW-SW_2024-2025/Lab0/axilite_matprod_files/HLS/tb_axil_mat_prod1.cpp"
axil_mat_prod1(matA, matB, matChw, 4, 4, 4);
#undef axil_mat_prod1
# 77 "C:/GitHub/CoP-HW-SW_2024-2025/Lab0/axilite_matprod_files/HLS/tb_axil_mat_prod1.cpp"
...
#ifndef HLS_FASTSIM
# 89 "C:/GitHub/CoP-HW-SW_2024-2025/Lab0/axilite_matprod_files/HLS/tb_axil_mat_prod1.cpp"
int main()
{
 ...
 print_mat(matChw, 4, 4);
    ...
    printf("After print_mat\n");

 return 0;
}
#endif
# 111 "C:/GitHub/CoP-HW-SW_2024-2025/Lab0/axilite_matprod_files/HLS/tb_axil_mat_prod1.cpp"
