...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "axil_mat_prod1.autotvin.dat"
	set constFileTvOut       "axil_mat_prod1.autotvout.dat"
	set constFileHdlTvIn     "axil_mat_prod1.autohdltvin.dat"
	set constFileHdlTvOut    "axil_mat_prod1.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
